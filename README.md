...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/cheapshark` | `npm install @voxgig-sdk/cheapshark` |
| Python | `voxgig-sdk-cheapshark` | `pip install voxgig-sdk-cheapshark` |
| PHP | `voxgig-sdk/cheapshark` | `composer require voxgig-sdk/cheapshark` |
| Golang | `github.com/voxgig-sdk/cheapshark-sdk/go` | `go get github.com/voxgig-sdk/cheapshark-sdk/go` |
| Ruby | `voxgig-sdk-cheapshark` | `gem install voxgig-sdk-cheapshark` |
| Lua | `voxgig-sdk-cheapshark` | `luarocks install voxgig-sdk-cheapshark` |
