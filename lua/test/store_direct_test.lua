...
describe("StoreDirect", function()
  it("should direct-list-store", function()
    local setup = store_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-store", setup.live and "live" or "unit")
...
function store_direct_setup(mockres)
