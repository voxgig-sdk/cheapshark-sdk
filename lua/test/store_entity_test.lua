...
describe("StoreEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CHEAPSHARK_TEST_STORE_ENTID JSON to run live")
      return
    end
...
function store_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CHEAPSHARK_TEST_STORE_ENTID")
