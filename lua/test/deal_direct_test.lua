...
describe("DealDirect", function()
  it("should direct-list-deal", function()
    local setup = deal_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-deal", setup.live and "live" or "unit")
...
function deal_direct_setup(mockres)
