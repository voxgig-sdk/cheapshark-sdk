...
describe("AlertDirect", function()
  it("should direct-list-alert", function()
    local setup = alert_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-alert", setup.live and "live" or "unit")
