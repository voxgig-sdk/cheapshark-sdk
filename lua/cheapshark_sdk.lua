...
local CheapsharkSDK = {}
CheapsharkSDK.__index = CheapsharkSDK
...
CheapsharkSDK._make_feature = _make_feature


function CheapsharkSDK.new(options)
  local self = setmetatable({}, CheapsharkSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CheapsharkSDK:options_map()
...
function CheapsharkSDK:get_utility()
  return Utility.copy(self._utility)
end


function CheapsharkSDK:get_root_ctx()
  return self._rootctx
end


function CheapsharkSDK:prepare(fetchargs)
...
function CheapsharkSDK:direct(fetchargs)
...
-- by passing it.
function CheapsharkSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CheapsharkSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "CheapsharkSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function CheapsharkSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CheapsharkSDK.new(sdkopts)
  sdk.mode = "test"
