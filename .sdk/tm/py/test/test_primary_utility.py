...
_runner = makeRunner(TEST_JSON_FILE, CheapsharkSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CheapsharkSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CheapsharkSDK.test(None, setup.get('a') or {})
