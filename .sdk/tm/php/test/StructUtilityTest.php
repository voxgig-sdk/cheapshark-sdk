...
// Cheapshark SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CheapsharkOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CheapsharkOmni::structfix($now, Struct::undef()))
                        !== json_encode(CheapsharkOmni::structfix($val, Struct::undef()))) {
