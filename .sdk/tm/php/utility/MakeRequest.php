...
// Cheapshark SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CheapsharkMakeRequest
{
    public static function call(CheapsharkContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CheapsharkResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CheapsharkResponse($fetched);
        } else {
