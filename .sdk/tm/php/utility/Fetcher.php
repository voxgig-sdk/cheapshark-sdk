...
// Cheapshark SDK utility: fetcher
...
class CheapsharkFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CheapsharkSDK/1.0)';
    ...
    public static function call(CheapsharkContext $ctx, string $fullurl, array $fetchdef): array
    {
