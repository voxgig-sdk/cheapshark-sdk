...
// Cheapshark SDK utility: graphql
//
...
class CheapsharkGraphql
{
    ...
    // equivalent.
    public static function body(CheapsharkContext $ctx): mixed
    {
    ...
    public static function errors(CheapsharkContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
