...
// Cheapshark SDK streaming feature
...
class CheapsharkStreamingFeature extends CheapsharkBaseFeature
{
    ...
    private function _iterate(CheapsharkResult $result): \Generator
    {
    ...
    private function _streamable(CheapsharkContext $ctx): bool
    {
