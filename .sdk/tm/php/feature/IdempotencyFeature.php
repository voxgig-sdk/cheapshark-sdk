...
// Cheapshark SDK idempotency feature
...
class CheapsharkIdempotencyFeature extends CheapsharkBaseFeature
{
    ...
    private function _mutating(CheapsharkContext $ctx): bool
    {
