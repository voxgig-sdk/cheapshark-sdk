...
// Cheapshark SDK ratelimit feature
...
class CheapsharkRatelimitFeature extends CheapsharkBaseFeature
{
    ...
    private function _acquire(CheapsharkContext $ctx): void
    {
    ...
    private function _track(CheapsharkContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
