...
|---|---|---|
| `ts/` | @voxgig-sdk/cheapshark-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cheapshark-sdk \
      --repository voxgig-sdk/cheapshark-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cheapshark-sdk` shows it, and
`npm trust revoke @voxgig-sdk/cheapshark-sdk --id=<id>` removes it.
