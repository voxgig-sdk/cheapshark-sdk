...
(0, node_test_1.describe)('AlertDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CheapsharkSDK({
    ...
    (0, node_test_1.test)('direct-list-alert', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-alert', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CHEAPSHARK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CheapsharkSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CHEAPSHARK_TEST_ALERT_ENTID'];
    ...
    const client = new __1.CheapsharkSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AlertDirect.test.js.map