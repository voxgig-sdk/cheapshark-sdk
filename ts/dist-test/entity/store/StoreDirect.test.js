...
(0, node_test_1.describe)('StoreDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-store', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-store', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CHEAPSHARK_TEST_STORE_ENTID'];
...
//# sourceMappingURL=StoreDirect.test.js.map