...
(0, node_test_1.describe)('GameEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set CHEAPSHARK_TEST_GAME_ENTID JSON to run live');
            return;
        }
        ...
        const game_ref01_match = {};
        const game_ref01_list = (await game_ref01_ent.list(game_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['CHEAPSHARK_TEST_GAME_ENTID'];
