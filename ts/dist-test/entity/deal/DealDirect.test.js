...
(0, node_test_1.describe)('DealDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-deal', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-deal', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CHEAPSHARK_TEST_DEAL_ENTID'];
...
//# sourceMappingURL=DealDirect.test.js.map