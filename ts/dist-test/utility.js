...
function envOverride(m) {
    if ('TRUE' === process.env.CHEAPSHARK_TEST_LIVE ||
        'TRUE' === process.env.CHEAPSHARK_TEST_OVERRIDE) {
    ...
    m.CHEAPSHARK_TEST_EXPLAIN = process.env.CHEAPSHARK_TEST_EXPLAIN || m.CHEAPSHARK_TEST_EXPLAIN;
    return m;
}
