...
class DealEntity extends CheapsharkEntityBase_1.CheapsharkEntityBase {
    ...
    make() {
        return new DealEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Deal[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
