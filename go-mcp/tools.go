...
type Args struct {
	Entity string         `json:"entity" jsonschema:"alert | deal | game | store"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CheapsharkSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "cheapshark_list",
		Description: "List records from Cheapshark. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "cheapshark_load",
		Description: "Load a single record from Cheapshark. " +
...
func runOp(client *sdk.CheapsharkSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CheapsharkSDK, name string) (sdk.CheapsharkEntity, error) {
