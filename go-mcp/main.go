// Command Cheapshark-mcp is an MCP server exposing the Cheapshark
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Cheapshark_list  — list records of an entity
//	Cheapshark_load  — load a single record of an entity
//
