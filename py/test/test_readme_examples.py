# Cheapshark SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CheapsharkSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CheapsharkSDK(...) and CheapsharkSDK.test(...) become
#      CheapsharkSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "cheapshark_sdk"
_SDK_CLASS = "CheapsharkSDK"
