...
from cheapshark_sdk.utility import register

# Load features
from cheapshark_sdk.feature.base_feature import CheapsharkBaseFeature
from cheapshark_sdk.features import _has_feature, _make_feature
...
class CheapsharkSDK:
    ...
    def get_utility(self):
        return CheapsharkUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CheapsharkSDK: graphql: " + str(msg))
            res["graphql"] = errors
