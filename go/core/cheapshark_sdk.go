...
func (sdk *CheapsharkSDK) OptionsMap() map[string]any {
...
func (sdk *CheapsharkSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CheapsharkSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CheapsharkSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CheapsharkSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CheapsharkSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CheapsharkSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CheapsharkSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CheapsharkSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CheapsharkSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CheapsharkSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
