...
func NewDealEntity(client *core.CheapsharkSDK, entopts map[string]any) *DealEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DealEntity) GetName() string { return e.name }
...
func (e *DealEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DealEntity) Deleted() bool {
	return e.deleted
}


func (e *DealEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDealEntity(e.client, opts)
}

func (e *DealEntity) Data(args ...any) any {
...
func (e *DealEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DealEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DealEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *DealEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DealEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DealEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DealEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
