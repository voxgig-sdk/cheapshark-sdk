...
func NewStoreEntity(client *core.CheapsharkSDK, entopts map[string]any) *StoreEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StoreEntity) GetName() string { return e.name }
...
func (e *StoreEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StoreEntity) Deleted() bool {
	return e.deleted
}


func (e *StoreEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStoreEntity(e.client, opts)
}

func (e *StoreEntity) Data(args ...any) any {
...
func (e *StoreEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *StoreEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StoreEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *StoreEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StoreEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StoreEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
