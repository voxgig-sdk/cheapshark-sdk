...
func NewAlertEntity(client *core.CheapsharkSDK, entopts map[string]any) *AlertEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AlertEntity) GetName() string { return e.name }
...
func (e *AlertEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AlertEntity) Deleted() bool {
	return e.deleted
}


func (e *AlertEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAlertEntity(e.client, opts)
}

func (e *AlertEntity) Data(args ...any) any {
...
func (e *AlertEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Alert; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AlertEntity) DataTyped(data ...Alert) Alert {
	if len(data) > 0 {
		return typedFrom[Alert](e.Data(asMap(data[0])))
	}
	return typedFrom[Alert](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Alert (all fields
// optional at the wire level).
func (e *AlertEntity) MatchTyped(match ...Alert) Alert {
	if len(match) > 0 {
		return typedFrom[Alert](e.Match(asMap(match[0])))
	}
	return typedFrom[Alert](e.Match())
}
...
func (e *AlertEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AlertEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AlertEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AlertListMatch and returns []Alert. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AlertEntity) ListTyped(reqmatch AlertListMatch, ctrl map[string]any) ([]Alert, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Alert](res), nil
}




func (e *AlertEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AlertCreateData and returns an Alert. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AlertEntity) CreateTyped(reqdata AlertCreateData, ctrl map[string]any) (Alert, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Alert{}, err
	}
	return typedFrom[Alert](res), nil
}



func (e *AlertEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *AlertEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// AlertRemoveMatch and returns an Alert. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AlertEntity) RemoveTyped(reqmatch AlertRemoveMatch, ctrl map[string]any) (Alert, error) {
...
func (e *AlertEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
