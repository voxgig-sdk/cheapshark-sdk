...
const testSeed = `map[string]any{"entity": map[string]any{"alert": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "game": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "store": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
