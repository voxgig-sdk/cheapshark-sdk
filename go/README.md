...
## Install
```bash
go get github.com/voxgig-sdk/cheapshark-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/cheapshark-sdk=../path/to/github.com/voxgig-sdk/cheapshark-sdk
```
...
```
github.com/voxgig-sdk/cheapshark-sdk/
...
The root package (`github.com/voxgig-sdk/cheapshark-sdk`) re-exports everything needed
