...
func registerSDKWords(r *eng.Registry, client *sdk.CheapsharkSDK) {
...
func runOp(client *sdk.CheapsharkSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
