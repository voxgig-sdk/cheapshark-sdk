...
module CheapsharkTestRunner
  ...
  def self.env_override(m)
    live = getenv("CHEAPSHARK_TEST_LIVE")
    override = getenv("CHEAPSHARK_TEST_OVERRIDE")
    ...
    explain = getenv("CHEAPSHARK_TEST_EXPLAIN")
    m["CHEAPSHARK_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CheapsharkTestRunner
Helpers = CheapsharkHelpers
Vs = VoxgigStruct
