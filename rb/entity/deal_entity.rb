...
class DealEntity
  ...
  #
  # @param reqmatch [DealListMatch, Hash, nil] match filter (any subset of
  #   Deal fields); defaults to nil, treated as an empty match that lists all.
