...
class StoreDirectTest extends TestCase
{
    public function test_direct_list_store(): void
    {
        $setup = store_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-store", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
