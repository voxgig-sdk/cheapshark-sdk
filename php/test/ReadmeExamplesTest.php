...
// Cheapshark SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CheapsharkSDK::test)
...
{
    private const SDK_CLASS = 'CheapsharkSDK';
    ...
    private const SDK_BASE = 'cheapshark_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../cheapshark_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
