...
class DealDirectTest extends TestCase
{
    public function test_direct_list_deal(): void
    {
        $setup = deal_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-deal", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
