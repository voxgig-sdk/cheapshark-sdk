...
class GameEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CHEAPSHARK_TEST_GAME_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function game_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CHEAPSHARK_TEST_GAME_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["CHEAPSHARK_TEST_GAME_ENTID"]);
