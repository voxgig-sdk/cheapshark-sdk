...
class CheapsharkTestRunner
{
    ...
    {
        $live = self::getenv('CHEAPSHARK_TEST_LIVE');
        $override = self::getenv('CHEAPSHARK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CHEAPSHARK_TEST_EXPLAIN');
...
class_alias('CheapsharkTestRunner', 'Runner');
class_alias('CheapsharkHelpers', 'Helpers');
