...
class DealEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DealEntity($this->_client, $opts);
    }

    /**
     * @param Deal|array $args Deal data (assoc-array) to store.
     */
    ...
    /**
     * @return Deal|array The current Deal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Deal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Deal fields).
     */
     ...
     *
     * @param DealListMatch|array|null $reqmatch Match filter (any subset
     *   of Deal fields) as an assoc-array; DealListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deal[]|array A list of Deal items as assoc-arrays at
