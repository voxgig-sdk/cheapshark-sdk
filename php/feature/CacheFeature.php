...
class CheapsharkCacheFeature extends CheapsharkBaseFeature
{
    ...
    private function _through(CheapsharkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
