...
class CheapsharkProxyFeature extends CheapsharkBaseFeature
{
    ...
    public function init(CheapsharkContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CheapsharkContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
