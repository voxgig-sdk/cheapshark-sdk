...
// Cheapshark SDK timeout feature
...
class CheapsharkTimeoutFeature extends CheapsharkBaseFeature
{
    ...
    private function _with_timeout(CheapsharkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CheapsharkContext $_ctx, float $ms): void
    {
        $client = $this->client;
