...
// Cheapshark SDK telemetry feature
...
class CheapsharkTelemetryFeature extends CheapsharkBaseFeature
{
    ...
    private function _close(CheapsharkContext $ctx, bool $ok): void
    {
