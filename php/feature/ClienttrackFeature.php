...
// Cheapshark SDK clienttrack feature
...
class CheapsharkClienttrackFeature extends CheapsharkBaseFeature
{
    ...
    public function PostConstruct(CheapsharkContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Cheapshark-SDK';
