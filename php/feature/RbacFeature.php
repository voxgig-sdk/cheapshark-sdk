...
class CheapsharkRbacFeature extends CheapsharkBaseFeature
{
    ...
    private function _required(CheapsharkContext $ctx): ?string
    {
    ...
    private function _reject(CheapsharkContext $ctx, string $required): void
    {
    ...
    private function _track(CheapsharkContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
